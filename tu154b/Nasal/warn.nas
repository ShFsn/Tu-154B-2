...
var horn_handler = maketimer (UPDATE_PERIOD, func{
...
var audio_handler = maketimer (UPDATE_PERIOD, func{
var pwr = getprop("tu154/systems/electrical/buses/DC27-bus-L/volts");
if( pwr == nil ) return;
if(  pwr < 13.0 )
	{ #27 V absent
...
var RV_OFFSET = 4;
var voice_handler = maketimer (UPDATE_PERIOD, func{
...
var indicator_handler = maketimer (UPDATE_PERIOD, func {
var pwr = getprop("tu154/systems/electrical/buses/DC27-bus-L/volts");
if( pwr == nil ) return;
if(  pwr < 13.0 )
	{ #27 V absent
...
setprop("tu154/systems/electrical/indicators/speed-limit", (param > 0.0));
...
# Elevator trim
if( abs( getprop("fdm/jsbsim/ap/pitch/met-integrator") ) < 0.01 )
...
# Nav light
nav_lighting (getprop( "tu154/switches/bano") ? 1 : 0);

# Strobes
strobe_control (getprop( "tu154/switches/omi") ? 1 : 0);
});
