...
var refuel = func{
      if (getprop("/fdm/jsbsim/fuel/sw-refuel") == 1 and getprop("/tu154/systems/electrical/buses/DC27-bus-L/volts") > 0 and getprop("/sim/model/ground-services/f-connect-r") == 1 and getprop("/sim/model/ground-services/chocks") == 1) {
            ...
            var time = 60;
            if (s_1 == 1) { interpolate("consumables/fuel/tank[0]/level-kg", t_1, time); }
            else { t_1 = -1; }
            if (s_2L == 1) { interpolate("consumables/fuel/tank[1]/level-kg", t_2L, time); }
            else { t_2L = -1; }
            if (s_2R == 1) { interpolate("consumables/fuel/tank[3]/level-kg", t_2R, time); }
            else { t_2R = -1; }
            if (s_3L == 1) { interpolate("consumables/fuel/tank[2]/level-kg", t_3L, time); }
            else { t_3L = -1; }
            if (s_3R == 1) { interpolate("consumables/fuel/tank[4]/level-kg", t_3R, time); }
            else { t_3R = -1; }
            if (s_4 == 1) { interpolate("consumables/fuel/tank[5]/level-kg", t_4, time); }
            else { t_4 = -1; }
...
valves = func {
      if (getprop("/fdm/jsbsim/fuel/sw-refuel-1") == 1) { setprop("/fdm/jsbsim/fuel/valve-refuel-1", 1); }
      if (getprop("/fdm/jsbsim/fuel/sw-refuel-1") == 0) { setprop("/fdm/jsbsim/fuel/valve-refuel-1", 0); }
      if (getprop("/fdm/jsbsim/fuel/sw-refuel-2L") == 1) { setprop("/fdm/jsbsim/fuel/valve-refuel-2L", 1); }
      if (getprop("/fdm/jsbsim/fuel/sw-refuel-2L") == 0) { setprop("/fdm/jsbsim/fuel/valve-refuel-2L", 0); }
      if (getprop("/fdm/jsbsim/fuel/sw-refuel-2R") == 1) { setprop("/fdm/jsbsim/fuel/valve-refuel-2R", 1); }
      if (getprop("/fdm/jsbsim/fuel/sw-refuel-2R") == 0) { setprop("/fdm/jsbsim/fuel/valve-refuel-2R", 0); }
      if (getprop("/fdm/jsbsim/fuel/sw-refuel-3L") == 1) { setprop("/fdm/jsbsim/fuel/valve-refuel-3L", 1); }
      if (getprop("/fdm/jsbsim/fuel/sw-refuel-3L") == 0) { setprop("/fdm/jsbsim/fuel/valve-refuel-3L", 0); }
      if (getprop("/fdm/jsbsim/fuel/sw-refuel-3R") == 1) { setprop("/fdm/jsbsim/fuel/valve-refuel-3R", 1); }
      if (getprop("/fdm/jsbsim/fuel/sw-refuel-3R") == 0) { setprop("/fdm/jsbsim/fuel/valve-refuel-3R", 0); }
      if (getprop("/fdm/jsbsim/fuel/sw-refuel-4") == 1) { setprop("/fdm/jsbsim/fuel/valve-refuel-4", 1); }
      if (getprop("/fdm/jsbsim/fuel/sw-refuel-4") == 0) { setprop("/fdm/jsbsim/fuel/valve-refuel-4", 0); }
}
setlistener("/fdm/jsbsim/fuel/sw-refuel-1", valves);
setlistener("/fdm/jsbsim/fuel/sw-refuel-2L", valves);
setlistener("/fdm/jsbsim/fuel/sw-refuel-2R", valves);
setlistener("/fdm/jsbsim/fuel/sw-refuel-3L", valves);
setlistener("/fdm/jsbsim/fuel/sw-refuel-3R", valves);
setlistener("/fdm/jsbsim/fuel/sw-refuel-4", valves);
